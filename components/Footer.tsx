...
export function Footer() {
  return (
    <footer className="bg-[#0B192C] text-slate-300 border-t border-slate-800 pt-16 pb-12 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              <li>
                <Link className="hover:text-accent transition-colors duration-200" href="/products">
                  Lihat Semua Produk
                </Link>
              </li>
              <li>
                <Link className="hover:text-accent transition-colors duration-200" href="/products?category=Blind%20Flange">
                  Blind Flange JIS/ANSI
                </Link>
              </li>
              <li>
                <Link className="hover:text-accent transition-colors duration-200" href="/products?category=Elbow">
                  Pipe Fittings Stainless
                </Link>
              </li>
              <li>
                <Link className="hover:text-accent transition-colors duration-200" href="/products?category=Ball%20Valve">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              <li>
                <Link className="hover:text-accent transition-colors duration-200" href="/blog">
                  Knowledge Center
                </Link>
              </li>
              <li>
                <Link className="hover:text-accent transition-colors duration-200" href="/downloads">
                  Engineering Downloads
                </Link>
              </li>
              <li>
                <Link className="hover:text-accent transition-colors duration-200" href="/about">
                  Tentang Kami
                </Link>
              </li>
              <li>
                <Link className="hover:text-accent transition-colors duration-200" href="/contact">
                  Hubungi Kami
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <a className="hover:text-accent transition-colors duration-200" href={`mailto:${siteConfig.email}`}>
                  {siteConfig.email}
                </a>
              </li>
              <li className="flex items-center gap-3">
                <span className="material-symbols-outlined text-accent text-base">call</span>
                <a className="hover:text-accent transition-colors duration-200" href={`tel:${siteConfig.phone}`}>
                  {siteConfig.phone}
                </a>
              </li>
            </ul>
